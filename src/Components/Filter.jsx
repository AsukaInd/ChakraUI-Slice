  ...
  return (
   ...
   <Box shadow={'md'} w={'712px'} h={'425px'} marginInline={'auto'} marginTop={'40px'}>
    ...
    <Flex justifyContent={'space-between'} marginInline={'20px'} height={'-webkit-fit-content'} > 
        <Text  fontWeight={'600px'} fontSize={'24px'} fontFamily={'inter'} backgroundColor={'white'}>Filter</Text>
    ...
    <Text fontWeight={'400'} fontFamily={'inter'}>Employment Status</Text>   
    ...
    <Box width={'full'} marginInline={'5'}>
    <Text fontWeight={'400'} fontFamily={'inter'}>Role</Text>   
    <Select placeholder='Select'>
    <option value='option1'>Option 1</option>
    <option value='option2'>Option 2</option>
    <option value='option3'>Option 3</option>
    ...
    <Box width={'full'} marginInline={'5'}>
    <Text fontWeight={'400'} fontFamily={'inter'}>Total Payroll</Text>   
    <Select placeholder='Select'>
    <option value='option1'>Option 1</option>
    <option value='option2'>Option 2</option>
    <option value='option3'>Option 3</option>
    ...
    <Box width={'full'} marginInline={'5'}>
    <Text fontWeight={'400'} fontFamily={'inter'}>Payroll Status</Text>   
    <Select placeholder='Select'>
    <option value='option1'>Option 1</option>
    <option value='option2'>Option 2</option>
    <option value='option3'>Option 3</option>
    ...
    <Box width={'full'} marginInline={'5'}>
    <Text fontWeight={'400'} fontFamily={'inter'}>Approved Expense </Text>   
    <Select placeholder='Select'>
    <option value='option1'>Option 1</option>
    <option value='option2'>Option 2</option>
    <option value='option3'>Option 3</option>
